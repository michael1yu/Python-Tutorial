...
You might also notice that in our function code, we have this keyword "return". This represent the value that we want to return back to whoever called the function. So when we did
